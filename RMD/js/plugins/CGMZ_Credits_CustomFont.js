 ...
 * rename the js file.
 * -----------------------------Latest Version---------------------------------
 * Hi all, this latest version adds a bit more customization to the credits
 * window. If you do not want the window to have a title line, you can leave
 * that blank and the plugin will not leave a blank line at the top anymore.
 * 
 * This update also added a customizable amount of blank space between credit
 * categories, instead of always being a whole blank line. This may help you
 * to fit more credits in the window.
 *
 * Version 1.2.0
 ...
 *
 * @param Credits Font
* @desc Name of the custom font to use for credits (must be loaded in your game project).
* @default
...
CGMZ.Versions["Credits"] = "1.2.0";
CGMZ.Credits = {};
CGMZ.Credits.parameters = PluginManager.parameters('CGMZ_Credits');
CGMZ.Credits.Font = CGMZ.Credits.parameters["Credits Font"] || ""; // NEW
...
Window_CGMZ_Credits.prototype.resetFontSettings = function() {
    Window_Base.prototype.resetFontSettings.call(this);
    if (CGMZ.Credits.Font) {
        this.contents.fontFace = CGMZ.Credits.Font;
    }
};
