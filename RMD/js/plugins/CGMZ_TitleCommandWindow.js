 ...
 * --------------------------Latest Version------------------------------------
 * Hi all, in this latest version adds the option to change how many columns
 * are in the title command window. This can help you make your command
 * window more horizontal if desired.
 *
 * It also added an integration with [CGMZ] Window Backgrounds, so you can
 * now show an image in the command window background including scrolling
 * parallax.
 *
 * Version 1.2.2
...
CGMZ.Versions["Title Command Window"] = "1.2.2";
